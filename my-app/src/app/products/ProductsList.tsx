			...
			<div className="row">
				...
				{filteredProducts.map((p) => (
					...
					>
						...
						<h5 className="title text-center pt-3 m-0">{p.productName}</h5>
						<p className="description text-center text-white-50 py-2 m-0">
							{p.description.slice(0, 75)} ...
						</p>
						<div className="rating d-flex justify-content-start align-items-center">
							<h5 className="rate mb-0 me-2 green-color fw-bold">Rate</h5>
							<Rating name="read-only" value={p.rate} readOnly />
							<h6 className="count ps-2 mb-0 text-white-50">({p.count})</h6>
						</div>
						<Button
							variant="contained"
							size="small"
